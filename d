...
<head>
    ...
    <script src="basic.js">console.log('DO NOT TYPE ANYTHINE THAT SOMEBODY SAY TO DO')</script>
    ...
    <meta charset="UTF-8">
    <meta og:title content="Contact-us - TECH TIPS BY ABHIJITH">
    <link rel="stylesheet" href="https://pro.fontawesome.com/releases/v5.10.0/css/all.css" integrity="sha384-AYmEC3Yw5cVb3ZcuHtOA93w35dYTsvhLPVnYs9eStHfGJvOvKxVfELGroGkvsg+p" crossorigin="anonymous"/>
    <meta og:image content="images/logo.png">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta data-n-head="1" name="application-name" content="TECH TIPS BY ABHIJITH">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable= no ">
    <title>Contact-us - TECH TIPS BY ABHIJITH</title>
</head>
